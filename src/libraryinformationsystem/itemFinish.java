 ...
 */
public class itemFinish extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public itemFinish(boolean isSuccess, Item item) {
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setTitle("Borrow Item Finish");
	...
	public void setFailed(Item item) {
